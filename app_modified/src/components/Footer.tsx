        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 border-t border-[#222222] pt-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="https://discord.gg/wQHbmjkh" target="_blank" rel="noopener noreferrer" className="text-[#555555] hover:text-[#34d399] transition-colors text-sm flex items-center gap-1">
              ...
              <ul className="space-y-2">
                <li>
                  <button
                    ...
                    className="text-[#555555] hover:text-[#34d399] transition-colors text-sm flex items-center gap-1"
                  >
